    ...
    return(
      ...
      <Navbar/>
         ...
         */}
            ...
            <div className="mt-[1.25rem] bg-[#40414F] bg-opacity-50 w-[20rem] h-32 rounded-lg flex-shrink-0 ">
...
{/* 2nd div */}
<div className="mt-[1.25rem] bg-[#40414F] bg-opacity-50 w-[20rem] h-32 rounded-lg flex-shrink-0 mx-5">
            ...
            {/* usage statics */}
            <div className="mt-[1.25rem] bg-[#40414F]  bg-opacity-50 rounded-lg w-[900px] h-[500px] lg:w-[1000px] md:w-[650px]">
